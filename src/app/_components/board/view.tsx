  ...
  return (
    <div className="flex min-h-full w-full flex-col items-stretch gap-5 p-2">
      ...
      <div className="flex h-full gap-3">
        <Column boardId={seachBoardId} name={ColumnEnum.TO_DO} cards={toDoCards} />
        <Column boardId={seachBoardId} name={ColumnEnum.IN_PROGRESS} cards={inProgressCards} />
        <Column boardId={seachBoardId} name={ColumnEnum.DONE} cards={doneCards} />
      </div>
    </div>
  );
}
